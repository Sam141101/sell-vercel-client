...
export const register = async (dispatch, user, navigate) => {
    ...
    try {
        const res = await axios.post('https://sell-vercel.vercel.app/api/auth/register', user);
...
export const logout = async (dispatch, navigate, id, token, axiosJWT) => {
    ...
    try {
        ...
        await axiosJWT.post('https://sell-vercel.vercel.app/api/auth/logout', id, {
...
export const getAllCart = async (token, dispatch, userId) => {
    try {
        const res = await axios.get('https://sell-vercel.vercel.app/api/carts/find/' + userId, {
            headers: { token: `Bearer ${token}` },
        });
...
export const addCart = async (token, dispatch, product, cartproduct) => {
    try {
        const res = await axios.post('https://sell-vercel.vercel.app/api/carts/', product, {
            headers: { token: `Bearer ${token}` },
        });
...
export const updateProduct = async (token, dispatch, id, update, condition) => {
    try {
        await axios.put('https://sell-vercel.vercel.app/api/carts/' + id, update, {
            headers: { token: `Bearer ${token}` },
        });
...
export const deleteProduct = async (token, dispatch, id, axiosJWT, navigate) => {
    try {
        await axios.delete('https://sell-vercel.vercel.app/api/carts/' + id, {
...
export const updateUser = async (token, dispatch, id, update) => {
    ...
    try {
        const res = await axios.put(`https://sell-vercel.vercel.app/api/users/${id}`, update, {
            headers: { token: `Bearer ${token}` },
        });
...
export const search = async (dispatch, id, update) => {
    try {
        const search = await axios.get('https://sell-vercel.vercel.app/api/search/');
